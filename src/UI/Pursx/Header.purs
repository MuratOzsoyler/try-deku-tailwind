...
header =
  Proxy
    ...
    <div class="container flex justify-between h-12 mx-auto">
        ...
        <div class="flex relative lg:static" ~menuDivAttrs~>
            <ul id="app-menu" class="-left-20 bg-gray-800 bg-opacity-90 text-center border-solid rounded-md border-1 p-2 border-slate-200 hidden absolute flex-col 
