(() => {
            ...
            return function(array) {
              function go2(bot, top2) {
                switch (top2 - bot) {
                  ...
                  case 2:
                    return apply4(map18(array2)(f(array[bot])))(f(array[bot + 1]));
                  case 3:
                    return apply4(apply4(map18(array3)(f(array[bot])))(f(array[bot + 1])))(f(array[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top2 - bot) / 4) * 2;
                    return apply4(map18(concat2)(go2(bot, pivot)))(go2(pivot, top2));
                }
              }
  ...
  var sampleOnRightOp = function(dictIsEvent) {
    ...
    var map18 = map(dictIsEvent.Filterable2().Functor1());
    return function(ef) {
      return function(ea) {
        return sampleOnRight1(ef)(map18(applyFlipped)(ea));
      };
    };
  };
  ...
  var traverse1Impl = function() {
    ...
    return function(apply4, map18, f) {
      var buildFrom = function(x, ys) {
        return apply4(map18(consList)(f(x)))(ys);
      };
  ...
  var style = /* @__PURE__ */ map7(function($282) {
    return unsafeAttribute(function(v) {
      return {
        key: "style",
        value: v
  ...
  var useState = function(a) {
    return function(f) {
      return bind3(useState$prime)(function(v) {
        return f(new Tuple(v.value0, alt5(pure10(a))(v.value1)));
      });
    };
  };
                      ...
                      return behaving(function(ee) {
                        return function(kx) {
                          return function(subscribe2) {
                            ...
                            return function __do5() {
                              subscribe2(sample6(map11(unsafeUnAttribute)(get3($$Proxy.value)(r)))(map14(function(fff) {
                                return function(xx) {
                              ...
                              return subscribe2(sample6(bhv)(ee))();
                            };
                          };
                        };
                      });
                  ...
                  return function(kx) {
                    return function(subscribe2) {
                      return function __do5() {
                        ...
                        return subscribe2(sample6(bhv)(eee))();
                      };
                    };
                  };
                });
                        ...
                        return behaving(function(ee) {
                          return function(kx) {
                            return function(subscribe2) {
                              ...
                              var evt1 = sample6(v3(info2)(v2))(ee);
                              var evt0 = sample6(__internalDekuFlatten4(function(v4) {
                                return v4;
                              }(get3($$Proxy.value)(r)))({
          ...
          return function(l) {
            var fn = function(v) {
              return bind22(liftST22(read2(deferredCache)))(function(o) {
                ...
                return discard32(void12(liftST22(modify(unwrap2(v1.newMap))(deferredCache))))(function() {
          ...
          return function(gnp) {
            return function(ffi) {
              var needsFreshNut = function __do5() {
                ...
                var unsubscribe = liftST4(subscribe(sample7(ohBehave)(pump.event))(executor))();
                pump.push(identity8)();
  ...
  var oneOf2 = /* @__PURE__ */ oneOf(foldableArray)(plusAPoll2);
  var selfT_2 = /* @__PURE__ */ selfT_();
  var applySecond4 = /* @__PURE__ */ applySecond(applyEffect);
  var log4 = /* @__PURE__ */ log3(monadEffectEffect);
  var empty8 = /* @__PURE__ */ empty(plusAPoll2);
  var bindFlipped2 = /* @__PURE__ */ bindFlipped(bindEffect);
  var map17 = /* @__PURE__ */ map(functorEffect);
  var $$void7 = /* @__PURE__ */ $$void(functorEffect);
  var bindMaybeT2 = /* @__PURE__ */ bindMaybeT(monadEffect);
  var discard22 = /* @__PURE__ */ discard3(bindMaybeT2);
  var monadEffectMaybe2 = /* @__PURE__ */ monadEffectMaybe(monadEffectEffect);
  var log1 = /* @__PURE__ */ log3(monadEffectMaybe2);
  var bind5 = /* @__PURE__ */ bind(bindMaybeT2);
  var liftEffect2 = /* @__PURE__ */ liftEffect(monadEffectMaybe2);
  ...
  var main = function __do4() {
    log2("\u{1F35D}")();
    return runInBody(bind3(useState$prime)(function(v) {
      return bind3(useState(""))(function(v1) {
        return makePursx2(pursx)({
          ...
          menuAttrs: oneOf2([selfT_2(function(v2) {
            return applySecond4(v.value0(v2))(log4("SelfT"));
          }), style(v1.value1)]),
          link1Attrs: empty8,
          menuBtnAttrs: click_(function(v2) {
            return function __do5() {
              log4("click start")();
              var getById = function(id2) {
                return bindFlipped2(getElementById(id2))(bindFlipped2(function($61) {
                  return function(v3) {
                    return map17(toNonElementParentNode)(v3);
                  }(document2($61));
                })(windowImpl));
              };
              return $$void7(runMaybeT(discard22(log1("maybe start"))(function() {
                return bind5(getById("menu-btn"))(function(menuBtn) {
                  return bind5(liftEffect2(clientWidth(menuBtn)))(function(btnw) {
                    return bind5(liftEffect2(clientTop(menuBtn)))(function(btny) {
                      return bind5(getById("app-menu"))(function(elem3) {
                        return liftEffect2(function __do6() {
                          var w = clientWidth(elem3)();
                          var y = clientTop(elem3)();
                          log4("x=" + (show6(w) + (", y=" + show6(y))))();
                          var toks = classList(elem3)();
                          $$void7(toggle(toks)("hidden"))();
                          $$void7(toggle(toks)("flex-col"))();
                          return log4("Menu Button Click")();
                        });
                      });
                    });
                  });
