(() => {
            ...
            appendRecord: function(v) {
              return function(ra) {
                return function(rb) {
                  ...
                  return insert5(append13(get3(ra))(get3(rb)))(tail2);
                };
              };
            }
          };
              ...
              function go2(bot, top2) {
                switch (top2 - bot) {
                  ...
                  default:
                    ...
                    return apply4(map17(concat2)(go2(bot, pivot)))(go2(pivot, top2));
                }
              }
  ...
  var applyList = {
    apply: function(v) {
      return function(v1) {
        ...
        ;
        if (v instanceof Cons) {
          return append1(map2(v.value0)(v1))(apply(applyList)(v.value1)(v1));
        }
        ;
  ...
  var applyOp = function(dictApplicative) {
    ...
    return function(ea) {
      return function(ef) {
        return apply4(map17(applyFlipped)(ea))(ef);
      };
    };
  };
  ...
  var composeKleisli1 = /* @__PURE__ */ composeKleisli(bindEffect);
    ...
    return function(v1) {
      return function(b, k) {
        ...
        var c1 = v(b, function(a) {
          return $$void2(liftST2(write(new Just(a))(latest)))();
        });
    ...
    return function(b, k) {
      ...
      var c = v(b, function(a) {
        ...
        if (o2 instanceof Nothing) {
          $$void2(liftST2(write(new Just(a))(latest)))();
          k(a);
  ...
  var bindToEffect = function(e) {
    return function(f) {
      return makeEvent(function(k) {
        return function __do6() {
          var u = subscribe(e)(composeKleisli1(f)(k))();
          return u;
        };
      });
    };
    ...
    return function(v1) {
      return function(tf, k) {
        ...
        var c1 = v(tf, function(a) {
          $$void2(liftST2(write(new Just(a))(latest1)))();
        ...
        var c2 = v1(tf, function(f) {
          $$void2(liftST2(write(new Just(f))(latest2)))();
  ...
  var sham = function(dictIsEvent) {
    ...
    var map24 = map(dictIsEvent.Filterable2().Functor1());
    return function(i) {
      return poll(function(e) {
        return keepLatest1(map24(function(f) {
          return map24(f)(i);
        })(e));
      });
    };
            ...
            return function(k) {
              return function __do7() {
                ...
                when2(!st)(function __do8() {
                  ...
                  $$void3(write(true)(started))();
                  return $$void3(flip(write)(unsub)(unsubscribe))();
                })();
  ...
  var compactableAPoll = function(dictFunctor) {
    return function(dictCompactable) {
      ...
      return function(dictPollable) {
        return {
          compact: filterMap1(dictPollable)(dictFunctor)(identity5),
          separate: partitionMap(dictPollable)(dictCompactable)(dictFunctor)(identity5)
        };
      };
    };
  };
  ...
  var dredge = function(dictApply) {
    var apply4 = apply(dictApply);
    var voidLeft3 = voidLeft(dictApply.Functor0());
    return function(f) {
      return function(v) {
        return function(eb) {
          return apply4(eb)(f(v(voidLeft3(eb)(identity5))));
        };
      };
    };
  };
  ...
  var applyAPoll = function(dictApply) {
    ...
    return {
      apply: function(v) {
        return function(v1) {
          return function(e) {
            return apply4(map24(function(ff2) {
              return function(v2) {
                return v2.value0(ff2(v2.value1));
              };
            })(v(voidLeft3(e)(identity5))))(v1(map24(Tuple.create)(e)));
          };
        };
      },
      Functor0: function() {
  ...
  var traverse1Impl = function() {
    ...
    return function(apply4, map17, f) {
              ...
              return makeLemmingEvent(function(subscribe2) {
                return function(k0) {
                  return function __do6() {
                          ...
                          return function __do8() {
                            ...
                            var myScope = liftST3(map13(Local.create)(function() {
                              ...
                              if (psr.scope instanceof Local) {
                                return map13(append3(pure1(psr.scope.value0))(append3(pure1("!"))(show2)))(v.ids(interpreter));
                              }
                              ;
                            ...
                            $$void4(liftST3(write(Listening.value)(stageRef)))();
                            ...
                            var c0 = liftST3(subscribe2(sample_2(fst(inner))(once4(memoKids.event)))(function(kid$prime) {
                              return function __do9() {
                                ...
                                if (kid$prime instanceof Remove && stage instanceof Listening) {
                                  $$void4(liftST3(write(Closed.value)(stageRef)))();
                                  var idRef = liftST3(read(myIds))();
                                  ...
                                  var myu = liftST3(read(myUnsub))();
                                  liftST3(myu)();
                                  var eltu = liftST3(read(eltsUnsub))();
                                  liftST3(eltu)();
                            ...
                            $$void4(liftST3(write(c0)(myUnsub)))();
                    ...
                    return function __do7() {
                      liftST3(join4(read(urf)))();
                      ugh();
                      return bind2(read(cancelInner))(foldl2(applySecond2)(pure5(unit)))();
                    };
                  };
                };
              });
  ...
  var map5 = /* @__PURE__ */ map(/* @__PURE__ */ functorAPoll(functorEvent));
  var pure7 = /* @__PURE__ */ pure(/* @__PURE__ */ applicativeAPoll(applyEvent));
  var selfT = function() {
    return map5(function($50) {
  ...
  var selfT1 = /* @__PURE__ */ selfT();
  var selfT_ = function() {
    return function($51) {
      return selfT1(pure7($51));
    };
  };
  ...
  var map6 = /* @__PURE__ */ map(/* @__PURE__ */ functorAPoll(functorEvent));
  var runOn = function(listener) {
    var $21 = map6($$const);
    return function($22) {
      return listener($21($22));
    };
  };

  // output/Deku.DOM.Attributes/index.js
  var map7 = /* @__PURE__ */ map(/* @__PURE__ */ functorAPoll(functorEvent));
  var klass = /* @__PURE__ */ map7(function($430) {
    return unsafeAttribute(function(v) {
      return {
        key: "class",
        value: v
  ...
  var click2 = /* @__PURE__ */ map8(function($385) {
    return unsafeAttribute(function(v) {
      return {
        key: "click",
        value: v
  ...
  var d = /* @__PURE__ */ map10(function($587) {
    return unsafeAttribute(function(v) {
      return {
        key: "d",
        value: v
  ...
  var useState$prime = function __do4() {
    var v = create4();
  ...
  var useRefST = function(a) {
    return function(e) {
      return function __do6() {
        var r = newSTRef(a)();
        var ep = createPure();
        var u = subscribe(sample5(e)(ep.event))(function(aa) {
          return liftST4($$void5(write(aa)(r)));
        })();
        ep.push(identity8)();
        return new Tuple(u, read(r));
      };
    };
  };
  var useHot = function(a) {
    return function __do6() {
      ...
      return new Tuple(v1.value0, new Tuple(v.value0, alt5(stToPoll(v1.value1))(v.value1)));
    };
  };
  ...
  var liftST5 = /* @__PURE__ */ liftST(monadSTST);
  var alt6 = /* @__PURE__ */ alt(/* @__PURE__ */ altAPoll(altEvent));
  var flattenArgs2 = {
    doLogic: function(pos) {
      return function(v) {
        return function(id2) {
                ...
                return function(v1) {
                  return function(subscribe2) {
                    return function __do6() {
                      ...
                      subscribe2(sample_3(e)(ee))(function(v3) {
                        return function(x) {
                          return $$void6(liftST5(write(x)(rf)));
                        };
                      })();
                      return subscribe2(sample6(__internalDekuFlatten3(v2)(i)(di))(ee))(identity9)();
                    };
                  };
                };
              };
  ...
  var useState$prime2 = function(f) {
    var go2 = function(i) {
      return function(di) {
        return behaving(function(ee) {
          return function(v) {
            return function(subscribe2) {
              return function __do6() {
                ...
                return subscribe2(sample6(__internalDekuFlatten3(v2)(i)(di))(ee))();
              };
            };
          };
        });
  ...
  var useHot2 = function(a) {
    return function(f) {
      return bind3(useState$prime2)(function(v) {
        return bind3(useRefST2(a)(v.value1))(function(r) {
          return f(new Tuple(v.value0, alt6(stToPoll(r))(v.value1)));
        });
      });
    };
  };

  // output/Deku.Pursx.Unsafe/index.js
  var empty7 = /* @__PURE__ */ empty(plusEvent);
  var sample7 = /* @__PURE__ */ sample(/* @__PURE__ */ pollable(eventIsEvent));
  var map11 = /* @__PURE__ */ map(/* @__PURE__ */ functorAPoll(functorEvent));
  var map15 = /* @__PURE__ */ map(functorEvent);
  var map23 = /* @__PURE__ */ map(functorST);
  var show5 = /* @__PURE__ */ show(showInt);
  var for_6 = /* @__PURE__ */ for_(applicativeST)(foldableMaybe);
  var pure9 = /* @__PURE__ */ pure(applicativeST);
    ...
    pursxToElement: function(v) {
      return function(v1) {
        return function(v2) {
          return {
            cache: empty4,
            element: new Element$prime(function(v3) {
              return function(v4) {
                return poll(function(v5) {
                  return empty7;
                });
              };
            })
            ...
            pursxToElement: function(pxScope) {
              return function(v) {
                return function(r) {
                  ...
                  var elt = function(parent2) {
                    return function(v3) {
                      return behaving(function(ee) {
                        return function(kx) {
                          return function(subscribe2) {
                            var bhv = v2(parent2)(v3);
                            var myId = reflectType2($$Proxy.value) + ("@!%" + pxScope);
                            return function __do6() {
                              subscribe2(sample7(map11(unsafeUnAttribute)(get3($$Proxy.value)(r)))(map15(function(fff) {
                                return function(xx) {
                                  return fff(unsafeSetAttribute(v3)(myId)(xx));
                                };
                              })(ee)))();
                              kx(v3.deferPayload(parent2.deferralPath)(v3.deleteFromCache({
                                id: myId
                              })))();
                              return subscribe2(sample7(bhv)(ee))();
                            };
                          };
                        };
                      });
                  ...
                  return {
                    cache: insert3(reflectType2($$Proxy.value))(true)(v1.cache),
                    element: new Element$prime(elt)
                  };
                };
              };
            }
      ...
      return function(verb) {
        return function(html) {
          return function(r) {
            var go2 = function(v) {
              return function(v1) {
                return behaving(function(eee) {
                  return function(kx) {
                    return function(subscribe2) {
                      return function __do6() {
                        var me = map23(show5)(v1.ids)();
                        var pxScope = map23(show5)(v1.ids)();
                        v.raiseId(me)();
                        var v2 = pursxToElement1(pxScope)($$Proxy.value)(r);
                        var v3 = domableToNode(v2.element);
                        var bhv = v3(v)(v1);
                        kx(v1.makePursx({
                          id: me,
                          parent: v.parent,
                        ...
                        return subscribe2(sample7(bhv)(eee))();
                      };
                    };
                  };
                });
            ...
            pursxToElement: function(pxScope) {
              return function(v) {
                return function(r) {
                  var v1 = pursxToElement1(pxScope)($$Proxy.value)(r);
                  return {
                    cache: insert3(reflectType2($$Proxy.value))(false)(v1.cache),
                    element: new Element$prime(function(info2) {
                      return function(v2) {
                        return behaving(function(ee) {
                          return function(kx) {
                            return function(subscribe2) {
                              var v3 = domableToNode(v1.element);
                              var evt1 = sample7(v3(info2)(v2))(ee);
                              var evt0 = sample7(__internalDekuFlatten4(function(v4) {
                                return v4;
                              }(get3($$Proxy.value)(r)))({
                                ...
                                pos: info2.pos,
                                ez: false,
                                deferralPath: info2.deferralPath,
                                dynFamily: Nothing.value
                              })(v2))(ee);
                              return function __do6() {
                                kx(v2.deferPayload(info2.deferralPath)(v2.deleteFromCache({
                                  id: reflectType2($$Proxy.value) + ("@!%" + pxScope)
                                })))();
                                return subscribe2(merge([evt0, evt1]))();
                              };
                            };
                          };
                        });
  ...
  var unsafeMakePursx$prime2 = /* @__PURE__ */ unsafeMakePursx$prime();
  ...
  var makePursx$prime = function(dictReflectable) {
    ...
    return function(dictReflectable1) {
      ...
      return function() {
        return function() {
          return function(dictPursxToElement) {
            var unsafeMakePursx$prime1 = unsafeMakePursx$prime2(dictPursxToElement);
            return function(verb) {
              return function(html) {
                return unsafeMakePursx$prime1(reflectType1(verb))(reflectType2(html));
              };
            };
          };
        };
  ...
  var sample8 = /* @__PURE__ */ sample(/* @__PURE__ */ pollable(eventIsEvent));
          ...
          return function(l) {
            var fn = function(v) {
              return bind22(liftST22(read(deferredCache)))(function(o) {
                ...
                return discard3(void12(liftST22(modify(unwrap2(v1.newMap))(deferredCache))))(function() {
                  return for_13(join5(unwrap2(v1.instructions)([])))(executor);
                });
              });
            };
            return fn;
  ...
  var __internalDekuFlatten5 = function(c) {
    return function(a) {
      return function(b) {
          ...
          return function(gnp) {
            return function(ffi) {
              var needsFreshNut = function __do6() {
                var myId = liftST6(newSTRef(Nothing.value))();
                var newRaiseId = applySecond3(gnp.raiseId)(function() {
                  var $130 = flip(write)(myId);
                  return function($131) {
                    return $$void7(liftST12($130(Just.create($131))));
                  };
                }());
                var ohBehave = __internalDekuFlatten5(gnp.ctor)({
                ...
                var pump = liftST6(create)();
                var unsubscribe = liftST6(subscribe(sample8(ohBehave)(pump.event))(executor))();
                pump.push(identity10)();
                var fetchedId = liftST6(read(myId))();
  ...
  var runInElement$prime = function(elt) {
    return function(eee) {
      return function __do6() {
        ...
        var seed = liftST7(newSTRef(0))();
        var cache = liftST7(newSTRef(empty2))();
        var executor = function(f) {
          return f(ffi);
        };
        var bhv = deku(elt)(eee)(fullDOMInterpret(seed)(cache)(executor));
        var bang = liftST7(create)();
        var u = liftST7(subscribe(sample_4(bhv)(bang.event))(executor))();
        bang.push(unit)();
        return function __do7() {
          var o = liftST7(read(cache))();
  ...
  var runInBody = function(a) {
    return $$void8(runInBody$prime(a));
  };
  ...
  // output/Web.CSSOMView.MediaQueryList/foreign.js
  function matches(mediaQueryList) {
    return function() {
      return mediaQueryList.matches;
    };
  }

  // output/Web.CSSOMView.MediaQueryList/index.js
  var toEventTarget = unsafeCoerce;

  // output/Web.CSSOMView.Window/foreign.js
  function getter(property) {
    return function(window2) {
      return function() {
        return window2[property];
      };
    };
  }
  function matchMedia(query) {
    return function(window2) {
      return function() {
        return window2.matchMedia(query);
      };
    };
  }
  var innerWidth2 = getter("innerWidth");
  var innerHeight2 = getter("innerHeight");
  var scrollX2 = getter("scrollX");
  var pageXOffset = getter("pageXOffset");
  var scrollY2 = getter("scrollY");
  var pageYOffset = getter("pageYOffset");
  var screenX2 = getter("screenX");
  var screenLeft = getter("screenLeft");
  var screenY2 = getter("screenY");
  var screenTop = getter("screenTop");
  var outerWidth2 = getter("outerWidth");
  var outerHeight2 = getter("outerHeight");
  var devicePixelRatio = getter("devicePixelRatio");
  ...
  var plusAPoll2 = /* @__PURE__ */ plusAPoll(plusEvent);
  var empty9 = /* @__PURE__ */ empty(plusAPoll2);
  var oneOf3 = /* @__PURE__ */ oneOf(foldableArray)(plusAPoll2);
  var selfT_2 = /* @__PURE__ */ selfT_();
  var dredge2 = /* @__PURE__ */ dredge(applyEvent);
  var sampleOnRight4 = /* @__PURE__ */ sampleOnRight(/* @__PURE__ */ isEventAPoll(eventIsEvent)(plusEvent)(/* @__PURE__ */ pollable(eventIsEvent)));
  var mapFlipped2 = /* @__PURE__ */ mapFlipped(/* @__PURE__ */ functorAPoll(functorEvent));
  var debug3 = /* @__PURE__ */ debug2(monadEffectEffect);
  var pure11 = /* @__PURE__ */ pure(applicativeEffect);
  var when3 = /* @__PURE__ */ when(applicativeEffect);
  var $$void9 = /* @__PURE__ */ $$void(functorEffect);
  var applyOp2 = /* @__PURE__ */ applyOp(/* @__PURE__ */ applicativeAPoll(applyEvent));
  ...
  var main = function __do5() {
    log4("\u{1F35D}")();
    var mql = bindFlipped2(matchMedia("(min-width: 1024px)"))(windowImpl)();
    var initTreshold = matches(mql)();
    var v = toEffect(useHot(initTreshold))();
    log4("Initial treshold=" + show6(initTreshold))();
    var mediaChangeHandler = eventListener(function(v1) {
      return function __do6() {
        var t = matches(mql)();
        log4("new treshold=" + show6(t))();
        return v.value1.value0(t)();
      };
    })();
    addEventListener("change")(mediaChangeHandler)(false)(toEventTarget(mql))();
    return runInBody(bind3(useHot2(Nothing.value))(function(v1) {
      return makePursx2(pursx)({
        iconPaths: fixed2([path([d_("M27.912 7.289l-10.324-5.961c-0.455-0.268-1.002-0.425-1.588-0.425s-1.133 0.158-1.604 0.433l0.015-0.008-10.324 5.961c-0.955 0.561-1.586 1.582-1.588 2.75v11.922c0.002 1.168 0.635 2.189 1.574 2.742l0.016 0.008 10.322 5.961c0.455 0.267 1.004 0.425 1.59 0.425 0.584 0 1.131-0.158 1.602-0.433l-0.014 0.008 10.322-5.961c0.955-0.561 1.586-1.582 1.588-2.75v-11.922c-0.002-1.168-0.633-2.189-1.573-2.742zM27.383 21.961c0 0.389-0.211 0.73-0.526 0.914l-0.004 0.002-10.324 5.961c-0.152 0.088-0.334 0.142-0.53 0.142s-0.377-0.053-0.535-0.145l0.005 0.002-10.324-5.961c-0.319-0.186-0.529-0.527-0.529-0.916v-11.922c0-0.389 0.211-0.73 0.526-0.914l0.004-0.002 10.324-5.961c0.152-0.090 0.334-0.143 0.53-0.143s0.377 0.053 0.535 0.144l-0.006-0.002 10.324 5.961c0.319 0.185 0.529 0.527 0.529 0.916z")])([]), path([d_("M22.094 19.451h-0.758c-0.188 0-0.363 0.049-0.515 0.135l0.006-0.004-4.574 2.512-5.282-3.049v-6.082l5.282-3.051 4.576 2.504c0.146 0.082 0.323 0.131 0.508 0.131h0.758c0.293 0 0.529-0.239 0.529-0.531v-0.716c0-0.2-0.11-0.373-0.271-0.463l-0.004-0.002-5.078-2.777c-0.293-0.164-0.645-0.26-1.015-0.26-0.39 0-0.756 0.106-1.070 0.289l0.010-0.006-5.281 3.049c-0.636 0.375-1.056 1.055-1.059 1.834v6.082c0 0.779 0.422 1.461 1.049 1.828l0.009 0.006 5.281 3.049c0.305 0.178 0.67 0.284 1.061 0.284 0.373 0 0.723-0.098 1.027-0.265l-0.012 0.006 5.080-2.787c0.166-0.091 0.276-0.265 0.276-0.465v-0.716c0-0.293-0.238-0.529-0.529-0.529z")])([])]),
        link1Attrs: empty9,
        menuAttrs: oneOf3([selfT_2(function(v2) {
          return function __do6() {
            log4("SelfT")();
            return v1.value0(new Just(v2))();
          };
        }), klass(flip(dredge2)(sampleOnRight4(v1.value1)(mapFlipped2(v.value1.value1)(function(t) {
          return function(mbul) {
            return new Tuple(t, mbul);
          };
        })))(function(e) {
          return bindToEffect(e)(function(v2) {
            return function __do6() {
              debug3("inTreshold=" + (show6(v2.value0) + "isNothing="))();
              return maybe(pure11(""))(function(ul) {
                var elem3 = toElement2(ul);
                return function __do7() {
                  when3(v2.value0)(function __do8() {
                    var toks = classList(elem3)();
                    return $$void9(add3(toks)("hidden"))();
                  })();
                  return className(elem3)();
                };
              })(v2.value1)();
            };
          });
        }))]),
        menuBtnAttrs: runOn(click2)(applyOp2(v1.value1)(mapFlipped2(v.value1.value1)(function(t) {
          return function(mbul) {
            return function __do6() {
              debug3("click")();
              return when3(!t)(traverse_3(function(ul) {
                var elem3 = toElement2(ul);
                return bindFlipped2(function($77) {
                  return debug3(function(v2) {
                    return "hidden is " + v2;
                  }(function(v2) {
                    if (v2) {
                      return "added";
                ...
                })(bindFlipped2(flip(toggle)("hidden"))(classList(elem3)));
              })(mbul))();
            };
          };
        })))
